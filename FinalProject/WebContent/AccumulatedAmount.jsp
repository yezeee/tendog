...
<head>
<meta charset="UTF-8">
<title>AccumulatedAmount.jsp</title>
	...
	<div style="font-family: Cafe24Ssurround; font-size: 28pt; width: 60%; margin: 0 auto; text-align: center;">
		...
		<div style="background-color: white; font-family: Pretendard; font-weight: 600; font-size: 12pt;">
			...
			<div style="width: 80%; margin: 0 auto; text-align: center;">
				...
				<br><br>
				<hr>
				<pre style="font-family: Pretendard; font-weight: 800;">수행일					정산일 					금액				누적금액</pre>
				<hr>
				<pre style="font-family: Pretendard; font-weight: 400;">24/08/16		           24/08/19 			     42,300			    78,300</pre>
				<hr>
				<pre style="font-family: Pretendard; font-weight: 400;">24/08/12		           24/08/15 			     36,000			    36,000</pre>
				<hr>
			</div>
			1			
			<br><br><br>
