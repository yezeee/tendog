...
<c:import url="Menu.jsp"></c:import>
	...
	<div class="main" style="background-color: white; display: flex; justify-content: space-between;">
		...
		<div class="content" style="width: 60%; text-align: center; font-size: 12pt; font-weight: 400;">
			<br><br><br>
			<span style="font-family: 'Cafe24Ssurround'; font-size: 20pt;">김예지 펫시터님, 펫시팅 업무가 시작됐어요!</span>
			<br><br>
				...
				<div style="width: 48%;">
					...
					<div style="display: flex; justify-content: space-between;">
						...
						<div style="width: 60%; font-weight: 600; font-size: 14pt; text-align: left;">
							<br>
							수행내역<br><br>
							최근 수행 일자&nbsp;&nbsp;&nbsp;<span style="font-weight: 400;">2024.09.10</span>
							<br><br>							
						</div>
						<div style="width: 5%;">
						</div>
				...
				<div style="width: 48%;">
					<div style="display: flex; justify-content: space-between;">
						...
						<div style="width: 60%; font-weight: 600; font-size: 14pt; text-align: left;">
							<br>
							정산관리<br><br>
							이번 달&nbsp;&nbsp;&nbsp;<span style="font-weight: 400;">70,000원</span>
							<br><br>							
						</div>
						<div style="width: 5%;">
						</div>
