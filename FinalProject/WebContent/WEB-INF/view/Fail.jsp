...
<c:import url="Menu.jsp"></c:import>
	...
	<div class="main" style="background-color: white; display: flex; justify-content: center; align-items: center; height: 500px; margin-bottom: 100px; padding-top: 100px;">
	    <p style="text-align: center; margin: 50px 0; font-family: Cafe24Ssurround; font-size: 30pt; line-height: 150%;">
	        ...
	        다시 도전하시겠어요?
		    <br><br>
		    <button type="button" id="sApplyBtn" style="background-color: #F2F2F2; border: none; border-radius: 50px; width: 30%; height: 80px; font-family: Pretendard; font-size: 16pt; font-weight: 600; margin-bottom: 10px;">지원서 작성하기</button><br>
		    <button type="button" id="viewListBtn" style="background-color: #F2F2F2; border: none; border-radius: 50px; width: 30%; height: 80px; font-family: Pretendard; font-size: 16pt; font-weight: 600;">내 지원서 보기</button>
	    </p>
	</div>
