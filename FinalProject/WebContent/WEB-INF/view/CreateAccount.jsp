		...
		<div style="width: 90%; margin: 0 auto; display: flex; justify-content: space-between; border: 2px solid #F2F2F2;">
			...
			<table style="margin-top: 10px;">
				...
				<tr>
					<th>비밀번호</th>
					<td>
						<input type="password" style="width: 150px;" id="pw" name="password">
				...
				<tr>
					<th>주민등록번호 (*)</th>
					<td>
						<input id="ssn1" name="ssn1" type="text" style="width: 100px;"> - <input id="ssn2" name="ssn2" type="password" style="width: 100px;" placeholder="0******">
					</td>
					<td>
				...
				<tr>
					<th>주소지 (*)</th>
					<td>
						<input type="text" id="sample4_postcode" name="zonecode" style="width: 50px;" readonly="readonly" placeholder="우편번호">
						...
						<input type="text" id="sample4_detailAddress" name="addr_detail" style="width: 300px;" placeholder="상세주소" readonly="readonly"><br>
					</td>
					<td>
						<span style="font-family: Pretendard; font-weight: 400; font-size: 12pt; color: red; display: none;">주소지는 필수입력항목입니다.</span>
						<input type="hidden" id="sido" name="class1"/>
						<input type="hidden" id="sigungu" name="class2"/>
						<input type="hidden" id="onlyRoadAddr" name="class3"/>
					</td>
				</tr>
				<tr>
					<th>연락처</th>
					<td><input type="text" id="tel" name="telephone" style="width: 150px;"></td>
				</tr>
			</table>
