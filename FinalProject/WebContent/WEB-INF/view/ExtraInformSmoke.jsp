...
<script type="text/javascript">
	...
	$().ready(function()
	{
		...
		{
			//alert($("input[name=smoke_yn]:checked").val());
			$(location).attr("href", "petsitterinsert.action?smokeYn=" + $("input[name=smoke_yn]:checked").val());
			//$(location).attr("href", "petsitterinsert.action");
		});
	});
		...
		<div
			...
			<div
				...
				<div
					...
					<input type="radio" name="smoke_yn" value="y" checked="checked"
						style="transform: scale(2.5); margin-right: 15px;">흡연 <input
						type="radio" name="smoke_yn" value="n"
