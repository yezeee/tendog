...
<div class="main" style="background-color: #F2F2F2;">
	...
	<div class="left" style="font-family: Pretendard; font-size: 14pt; width: 20%; float: left; text-align: right;">
	    ...
	    &nbsp;&nbsp;&nbsp;&nbsp;
	    &nbsp;&nbsp;&nbsp;&nbsp;
		<a href="ModifyUserInfo.jsp" style="font-weight: 500; line-height: 150%;">회원정보&nbsp;&nbsp;&nbsp;&nbsp;<br></a>
		<span style="font-weight: 800;">비밀번호 변경&nbsp;&nbsp;&nbsp;&nbsp;</span>
	</div>
	<div style="font-family: Cafe24Ssurround; font-size: 28pt; width: 60%; margin: 0 auto; text-align: center;">
		비밀번호 변경
		<div style="background-color: white; font-family: Pretendard; font-weight: 600; font-size: 14pt;">
			<hr>
			<br><br>
			<div style="line-height: 80%;">
				<span style="vertical-align: middle;">기존 비밀번호&nbsp;&nbsp;</span>
				<input type="text">
				<br><br>
				<span style="vertical-align: middle;">바꿀 비밀번호&nbsp;&nbsp;</span>
				<input type="text">
				<br><br>
			...
			<br>
			<button type="button" style="width: 100px;">변경하기</button>
			<br><br>
		</div>
	</div>
	<br><br>
